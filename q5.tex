...
\begin{figure}
  \includegraphics[scale=1.0]{flux-diagram}
  \caption{Flux Overview}
\end{figure}

The above image was sourced from http://www.infoq.com/news/2014/05/facebook-mvc-flux. \say{The Store contains all the application’s data and the Dispatcher replaces the initial Controller, deciding how the Store is to be
